...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.label_show.repaint()  # 强制刷新
        self.label_show.setStyleSheet("border-image: url(UIProgram/ui_imgs/11.png);")
        # self.label_show.setStyleSheet("border-image: url(:/icons/ui_imgs/11.png);")  # UIProgram/ui_imgs/11.png
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "马铃薯种薯芽眼识别软件"))
        ...
        self.label_3.setText(_translate("MainWindow", "马铃薯种薯芽眼识别软件"))
        # self.label_2.setText(_translate("MainWindow", "公众号：阿旭算法与机器学习"))
        self.label_12.setText(_translate("MainWindow", "作者：黄杰"))
